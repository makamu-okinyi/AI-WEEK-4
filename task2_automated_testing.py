...
class AutomatedLoginTest:
    ...
    def run_invalid_login_test(self, username, password):
        """Automates a test with invalid credentials."""
        self.setup()
        ...
        # 4. Verification: Check for the failure/error message
        try:
            ...
            if "Your username is invalid!" in error_message.text:
                ...
                return "Success"
                 ...
                 print("❌ TEST FAILED: Invalid login did not show the expected error message.")
                 return "Failure"
        except:
            print("❌ TEST FAILED: Did not find the expected error message element.")
            return "Failure"
